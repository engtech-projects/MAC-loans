                            ...
                            <div class="row mb-16">
                                <div class="col-xl-3 col-lg-6">
                                    <div class="info-display">
                                        ...
                                        <span>P {{ loanDetails.type == "Prepaid" ?
                                            formatToCurrency(Math.ceil(loanDetails.loan_amount /
                                                loanDetails.no_of_installment))
                                            : formatToCurrency(loanDetails.amortization.total) }}</span>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6">
                                    <div class="info-display">
                                ...
                                <div class="col-xl-3 col-lg-6">
                                    <div class="info-display">
                                        ...
                                        <span>{{ loanDetails.terms }} Days / {{ Math.ceil(loanDetails.terms / 30) }}
                                            Month
                                            (s)</span>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-stripped mb-64">
                                        ...
                                        <tbody>
                                            <tr v-for="(p, pi) in loanDetails.payments" :key="pi">
                                                ...
                                                <td><a v-show="hasAccessToEdit" @click.prevent="editPayment = p"
                                                        data-toggle="modal" data-target="#editPaymentModal" href=""><i
                                        ...
                                        <table class="table table-stripped mb-64">
                                            ...
                                            <tbody>
                                                <tr v-for="(as, a) in amortSched" :key="a">
                                                    ...
                                                    <td><a v-show="hasAccessToEdit" @click.prevent="editAmort = as"
                    ...
                    <div class="flex-col schedule-row" v-if="showSchedule">
                        ...
                        <div class="d-flex">
                            <div class="flex-1 d-flex flex-column justify-content-between pr-16 br-primary-dark">
                                <div class="mb-45">
                                    <span
                                        class="pb-10 text-primary-dark text-lg bb-primary-dark text-bold text-block">Amortization
                                        Scheduled Payment</span>
                                    <div class="d-flex justify-content-between py-5 text-primary-dark">
                                        <div class="flex-4 d-flex justify-content-between">
                                            <span>Date</span>
                                            <span>:</span>
                                        </div>
                                        <span class="flex-3 pl-10">{{ loanDetails.current_amortization.amortization_date
                                            }}</span>
                                    </div>
                                    <div class="d-flex justify-content-between py-5 text-primary-dark">
                                        <div class="flex-4 d-flex justify-content-between">
                                        ...
                                        <span class="flex-3 pl-10">P
                                            {{ formatToCurrency(loanDetails.current_amortization.schedule_principal)
                                            }}</span>
                                    </div>
                                    <div class="d-flex justify-content-between py-5 text-primary-dark">
                                        <div class="flex-4 d-flex justify-content-between">
                                        ...
                                        <span class="flex-3 pl-10">P
                                            {{ formatToCurrency(loanDetails.current_amortization.schedule_interest)
                                            }}</span>
                                    </div>
                                </div>
                                <div>
                                    <span class="text-lg text-bold text-primary-dark">TOTAL</span>
                                    <span class="text-block bg-primary-dark text-white px-16 text-45 mr-36">P
                                        {{ formatToCurrency(totalScheduledPayment) }}</span>
                                </div>
                            </div>
                            <div class="flex-1 px-16 br-primary-dark d-flex flex-column justify-content-between">
                                <div class="mb-45">
                                    <span
                                        class="pb-10 text-primary-dark text-lg bb-primary-dark text-bold text-block">Total
                                        Amount Due</span>
                                    <div class="d-flex justify-content-between py-5 text-primary-dark">
                                        <div class="flex-4 d-flex justify-content-between">
                                            <span>Principal</span>
                                ...
                                <div>
                                    <span class="text-lg text-bold text-primary-dark">TOTAL</span>
                                    <span class="text-block bg-primary-dark text-white px-16 text-45 mr-36">P
                                        {{ formatToCurrency(totalDue) }}</span>
                                </div>
                            </div>
                            <div class="flex-1 px-16 d-flex flex-column justify-content-between">
                                <div class="mb-45">
                                    <span
                                        class="pb-10 text-primary-dark text-lg bb-primary-dark text-bold text-block">Outstanding
                                        Balance</span>
                                    <div class="d-flex justify-content-between py-5 text-primary-dark">
                                        <div class="flex-4 d-flex justify-content-between">
                                        ...
                                        <span class="flex-3 pl-10">P
                                            {{ formatToCurrency(loanDetails.remaining_balance.principal.balance)
                                            }}</span>
                                    </div>
                                    <div class="d-flex justify-content-between py-5 text-primary-dark">
                                        <div class="flex-4 d-flex justify-content-between">
                                        ...
                                        <span class="flex-3 pl-10">P
                                            {{ formatToCurrency(loanDetails.remaining_balance.interest.balance -
                                                loanDetails.remaining_balance.rebates.credit) }}</span>
                                    </div>
                                    <div class="d-flex justify-content-between py-5 text-primary-dark">
                                        <div class="flex-4 d-flex justify-content-between">
                                            <span>Surcharge</span>
                                        ...
                                        <span class="flex-3 pl-10">P
                                            {{ formatToCurrency(loanDetails.remaining_balance.pdi.balance +
                                                loanDetails.remaining_balance.penalty.balance) }}</span>
                                    </div>
                                </div>
                                <div>
                                    <span class="text-lg text-bold text-primary-dark">TOTAL</span>
                                    <span class="text-block bg-primary-dark text-white px-16 text-45 mr-36">P
                                        {{ formatToCurrency(loanDetails.remaining_balance.memo.balance +
                                            loanDetails.remaining_balance.pdi.balance
                                            + loanDetails.remaining_balance.penalty.balance) }}</span>
                                </div>
                            </div>
                            ...
                            <div class="flex-1 d-flex flex-column pr-16 br-primary-dark">
                                <div class="d-flex flex-column pxy-15 mt-10 bg-peach mr-36">
                                    <div class="d-flex justify-content-between text-primary-dark">
                                        ...
                                        <span class="flex-3 pl-10">P
                                            {{ formatToCurrency(loanDetails.current_amortization.short_principal)
                                            }}</span>
                                    </div>
                                    <div class="d-flex justify-content-between mb-10 text-primary-dark">
                                        ...
                                        <span class="flex-3 pl-10">P
                                            {{ formatToCurrency(loanDetails.current_amortization.advance_principal)
                                            }}</span>
                                    </div>
                                    <div class="d-flex justify-content-between text-primary-dark">
                                        <div class="flex-4 d-flex justify-content-between">
                                        ...
                                        <span class="flex-3 pl-10">P
                                            {{ formatToCurrency(loanDetails.current_amortization.short_interest)
                                            }}</span>
                                    </div>
                                    <div class="d-flex justify-content-between text-primary-dark">
                                        <div class="flex-4 d-flex justify-content-between">
                                        ...
                                        <span class="flex-3 pl-10">P
                                            {{ formatToCurrency(loanDetails.current_amortization.advance_interest)
                                            }}</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="d-flex flex-column">
                                    <div class="d-flex flex-column flex-lg-row">
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.principal" type="number"
                                        ...
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.interest" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.pdi" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.penalty" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-column flex-lg-row">
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.rebates" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.amount_applied" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.total_payable" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex flex-column flex-lg-row">
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.short_principal" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.advance_principal" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.advance_interest" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.short_interest" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex flex-column flex-lg-row">
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.rebates_approval_no" type="text"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.penalty_approval_no" type="text"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.pdi_approval_no" type="text"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editPayment.vat" type="text"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-column flex-lg-row">
                                        ...
                                        <div class="form-group mb-10 mr-16 flex-1"></div>
                                        <div class="form-group mb-10 mr-16 flex-1 d-flex align-items-end">
                                            <button @click="cancelPayment()" data-dismiss="modal"
                                                class="btn btn-sm btn-warning m-2" style="margin-bottom:1rem;">CANCEL
                                                PAYMENT</button>
                                            <button @click="updatePayment()" data-dismiss="modal"
                                    ...
                                    <div class="d-flex flex-column flex-lg-row">
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            <label for="transactionDate" class="form-label">Amortization
                                                Schedule</label>
                                            <div class="form-group">
                                                <select v-model="editPayment.amortization_id"
                                                    class="form-control form-input">
                                        ...
                                        <div class="form-group mb-10 mr-16 flex-1 d-flex align-items-end">
                                            <button @click="updatePaymentDistribute()" data-dismiss="modal"
                                                class="btn btn-warning"
                                                style="margin-bottom:1rem;width:100%;height:47px;">Update and
                                                Distribute</button>
                                        </div>
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex flex-column flex-lg-row">
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editAmort.amortization_date" type="date"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            <label for="transactionDate" class="form-label">Principal</label>
                                            <div class="form-group">
                                                <input v-model="editAmort.principal" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            <label for="transactionDate" class="form-label">Interest</label>
                                            <div class="form-group">
                                                <input v-model="editAmort.interest" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editAmort.total" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-column flex-lg-row">
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editAmort.principal_balance" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                            ...
                                            <div class="form-group">
                                                <input v-model="editAmort.interest_balance" type="number"
                                                    class="form-control form-input">
                                            </div>
                                        </div>
                                        <div class="form-group mb-10 mr-16 flex-1">
                                        ...
                                        <div class="form-group mb-10 mr-16 flex-1 d-flex align-items-end">
                                            <button @click="updateAmort()" data-dismiss="modal" class="btn btn-success"
                                                style="margin-bottom:1rem;width:100%;height:47px;">UPDATE</button>
                                        </div>
                                    </div>
                                </div>
                            </section>
...
export default {
    ...
    methods: {
        ...
        cancelPayment: function () {
            this.editPayment.status = 'cancelled'
            axios.put(this.baseURL() + 'api/payment/' + this.editPayment.payment_id, this.editPayment, {
                headers: {
                    'Authorization': 'Bearer ' + this.token,
                    'Content-Type': 'application/json',
                ...
                .then(function (response) {
                    this.notify('', 'Payment successfully cancelled.', 'success');
                }.bind(this))
                .catch(function (error) {
                    console.log(error);
                    this.notify('', error.response.data.data, 'error');
