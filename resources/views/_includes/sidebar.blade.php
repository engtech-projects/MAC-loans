        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                @if (Auth::user()->hasAccess('view borrower') ||
                    ...
                    <li
                        class="nav-item {{ isset($nav) && isActive($nav[0], 'client information') ? 'active menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            @if (Auth::user()->hasAccess('view borrower'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'personal information list') ? 'active menu-open' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line invis"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line"></div>
                                    </div>
                                    <a href="{{ route('client_information.personal_information_list') }}"
                                        class="nav-link flex">
                            ...
                            @if (Auth::user()->hasAccess('view statement of accounts'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'statement of accounts list') ? 'active menu-open' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line"></div>
                                    </div>
                                    <a href="{{ route('client_information.statement_of_accounts_list') }}"
                                        class="nav-link">
                            ...
                            @if (Auth::user()->hasAccess('view balance inquiry'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'balance inquiry') ? 'active menu-open' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line"></div>
                                        <div class="mid-circle"></div>
                ...
                @if (Auth::user()->hasAccess('view release entry') ||
                    ...
                    <li
                        class="nav-item {{ isset($nav) && isActive($nav[0], 'transaction') ? 'active menu-open' : '' }}">
                        <a href="#" class="nav-link main-link">
                            <p>
                                Transaction
                                <i class="right fas fa-caret-right"></i>
                        ...
                        <ul class="nav nav-treeview">
                            @if (Auth::user()->hasAccess('view release entry'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'release entry') ? 'active menu-open' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line invis"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line"></div>
                            ...
                            @if (Auth::user()->hasAccess('view override release'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'override release') ? 'active menu-open' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line"></div>
                            ...
                            @if (Auth::user()->hasAccess('view rejected release'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'rejected release') ? 'active menu-open' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line"></div>
                            ...
                            @if (Auth::user()->hasAccess('view repayment entry'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'repayment entry') ? 'active menu-open' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line"></div>
                            ...
                            @if (Auth::user()->hasAccess('view override payment'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'override payment') ? 'active menu-open' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line invis"></div>
                ...
                @if (Auth::user()->hasAccess('view cancelled payments') ||
                    ...
                    <li
                        class="nav-item {{ isset($nav) && isActive($nav[0], 'maintenance') ? 'active menu-open' : '' }}">
                        <a href="#" class="nav-link main-link">
                            <p>
                                Maintenance
                                <i class="right fas fa-caret-right"></i>
                        ...
                        <ul class="nav nav-treeview">
                            @if (Auth::user()->hasAccess('view cancelled payments'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'cancel payments') ? 'active' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line invis"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line"></div>
                            ...
                            @if (Auth::user()->hasAccess('view product setup'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'product setup') ? 'active' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line"></div>
                            ...
                            @if (Auth::user()->hasAccess('view center'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'center ao') ? 'active' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line"></div>
                            ...
                            @if (Auth::user()->hasAccess('view users'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'user settings') ? 'active' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line"></div>
                            ...
                            @if (Auth::user()->hasAccess('view gl setup'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'gl setup') ? 'active' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line"></div>
                            ...
                            @if (Auth::user()->hasAccess('view account retagging'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'account retagging') ? 'active' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line"></div>
                            ...
                            @if (Auth::user()->hasAccess('view deduction rate'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'deduction rates') ? 'active' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line"></div>
                            ...
                            @endif
                            @if (Auth::user()->hasAccess('view activity logs'))
                                <li
                                    class="nav-item pick {{ isset($nav) && isActive($nav[1], 'activity logs') ? 'active' : '' }}">
                                    <div class="flex navicon">
                                        <div class="top-line"></div>
                                        <div class="mid-circle"></div>
                                        <div class="bottom-line invis"></div>
                                    </div>
                                    <a href="{{ route('maintenance.activity_logs') }}" class="nav-link">
                                        <p>Activity Logs</p>
                                    </a>
                                </li>
                            @endif
                ...
                @if (Auth::user()->hasAccess('set beginning/end of day'))
                    <li
                        class="nav-item pick {{ isset($nav) && isActive($nav[0], 'end of day') ? 'active menu-open' : '' }}">
